    ...
    <div class="container d-flex align-items-center justify-content-center min-vh-100">
        <div class="row shadow rounded-4 bg-white overflow-hidden w-100" style="max-width: 900px;">
            ...
            <div class="col-md-6 p-5">
                <h4 class="mb-4 text-center">Masuk ke Akunmu</h4>
                <form method="POST" action="database/proses_login.php">
                    <div class="mb-3">
                        <label for="email" class="form-label">Email / Username</label>
                        <input type="identifier" class="form-control" id="identifier" name="identifier" placeholder="contoh@email.com / contoh123" required>
                    </div>
                    <div class="mb-3">
                ...
                <p class="text-center mt-4 mb-0 small">Belum punya akun? <a href="registrasi.php" class="text-primary">Daftar
                        sekarang</a></p>
            </div>
        </div>
    </div>
